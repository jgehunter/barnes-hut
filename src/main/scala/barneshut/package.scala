...
package object barneshut {
  ...
  extends Quad {
    val (mass: Float, massX: Float, massY: Float) = (bodies.foldLeft(0f)(_ + _.mass),
                                bodies.foldLeft(0f) {case (sum, body) => sum + body.mass*body.x} / bodies.foldLeft(0f)(_ + _.mass) , 
                                bodies.foldLeft(0f) { case (sum, body) => sum + body.mass*body.y} / bodies.foldLeft(0f)(_ + _.mass) )
